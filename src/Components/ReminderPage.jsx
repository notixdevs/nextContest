...
const ReminderPage = () => {
    ...
    useEffect(() => {
            ...
            try {
                chrome.storage.local.get("pinnedContests", (result) => {
                    if (chrome.runtime.lastError) {
                        console.error("Error fetching pinned contests:", chrome.runtime.lastError);
                        setLoading(false);
                        return;
                    }
                    ...
                    if (Array.isArray(pinnedContests) && pinnedContests.length > 0) {
                        const firstContest = pinnedContests[0];
                        if (isContestLive(firstContest.start, firstContest.end) !== "ENDED") {
        ...
        // Refresh every 30 seconds to update contest status
        ...
        return (
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-2xl mx-auto flex flex-col ">
                    ...
                    <h2 className="text-xl font-bold align-items  text-gray-800 mb-4">Contest Starts Soon!!</h2>
            ...
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 text-lg">No pinned contests available</p>
                        <p className="text-gray-500 text-sm mt-2">Pin a contest to see reminders here</p>
                    </div>
                </div>
            </div>
        );
